...
router.post('/auth/firebase-login/replace-deleted-account', requireFields('idToken','provider'), authController.replaceDeletedAccountAndFirebaseLogin);
...
router.post('/auth/verify', requireFields('email','otp'), authController.verifyOtp);
router.post('/auth/verify-email', requireFields('email','otp'), authController.verifyOtp);
router.post('/auth/forget', requireFields('email'), authController.forgotPassword);
...
router.post('/v1/auth/firebase-login/replace-deleted-account', requireFields('idToken','provider'), authController.replaceDeletedAccountAndFirebaseLogin);
...
router.post('/v1/auth/verify', requireFields('email','otp'), authController.verifyOtp);
router.post('/v1/auth/verify-email', requireFields('email','otp'), authController.verifyOtp);
router.post('/v1/auth/forget', requireFields('email'), authController.forgotPassword);
